...
- Aggregated Visceral/Renal Risk: ${results.riskLevel.toUpperCase()}`;
  ...
  return (
    <div className="space-y-6" id="metabolic-analyzer-root">
      ...
      <form onSubmit={handleCalculate} style={{ backgroundColor: "#6b74e6" }} className="bento-card p-6 space-y-6">
        <div className="border-b border-slate-100 dark:border-slate-800/40 pb-3">
          <h2 className="text-base font-extrabold text-[#dfe0ed] uppercase tracking-wider flex items-center gap-2 font-sans">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="space-y-1.5">
            <label className="text-[11px] font-bold text-[#dfe0ed] tracking-wide block">Patient Name</label>
            <input 
              type="text" 
          ...
          <div className="space-y-1.5">
            <label className="text-[11px] font-bold text-[#e2e3e6] tracking-wide block">Patient Assigned Sex</label>
            <select
              value={formData.gender}
              onChange={e => handleInputChange("gender", e.target.value)}
              className="w-full bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 rounded-xl px-3 py-2 text-xs font-bold text-slate-800 dark:text-slate-100 focus:ring-1 focus:ring-indigo-500 bg-transparent cursor-pointer"
            >
          ...
          <div className="space-y-1.5">
            <label className="text-[11px] font-bold text-[#cfd6e0] tracking-wide block">Patient Biological Age</label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                <label className="text-[11px] font-bold text-[#dfe0ed] tracking-wide">Waist Circumference</label>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                <label className="text-[11px] font-bold text-[#dfe0ed] tracking-wide">Fasting Blood Glucose</label>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                <label className="text-[11px] font-bold text-[#dfe0ed] tracking-wide">Serum Triglycerides</label>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                <label className="text-[11px] font-bold text-[#dfe0ed] tracking-wide">HDL Cholesterol</label>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                <label className="text-[11px] font-bold text-[#dfe0ed] tracking-wide">Systolic Blood Pressure</label>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                <label className="text-[11px] font-bold text-[#dfe0ed] tracking-wide">Diastolic Blood Pressure</label>
